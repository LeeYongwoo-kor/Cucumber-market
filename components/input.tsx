      ...
      {kind === "phone" ? (
        <div className="flex rounded-md shadow-sm">
          ...
          <input
            ...
            {...register}
            required={required}
            className="focus:green-600 focus:green-600 w-full appearance-none rounded-md rounded-l-none border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:outline-none"
          />
        </div>
      ) : null}
    </div>
