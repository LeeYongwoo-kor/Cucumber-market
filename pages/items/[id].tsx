      ...
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <p className="my-6 text-base text-gray-700">
            ...
            consectetur adipisicing elit. Minus sint vero quisquam saepe officia
            molestiae autem perspiciatis ea iste nobis quia harum molestias
            numquam, a perferendis minima quibusdam placeat error.
          </p>
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 rounded-md bg-green-600 py-3 font-medium text-white shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2">
              Talk to seller
            </button>
