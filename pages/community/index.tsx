  ...
  return (
    <Layout hasTabBar title="Community">
      <div className="space-y-8 px-4 py-16">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div key={i} className="flex flex-col items-start">
            ...
            <div className="mt-2 text-gray-700">
              <span>
                <span className="font-medium text-green-600">Q.</span> What is
                the best tteokbokki restaurant?
              </span>
            </div>
        ...
        <button className="fixed bottom-16 right-5 rounded-full bg-green-600 p-4 text-white shadow-xl transition-colors hover:bg-green-700">
          <svg
            className="h-6 w-6"
            fill="none"
            stroke="currentColor"
